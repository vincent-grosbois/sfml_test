...
public : 
	...
	template<typename U>
	struct rebind {
		typedef FramePagedMemory<U> other;
	};
...
public : 
	...
	explicit FramePagedMemory(const FramePagedMemory& other) {
		pagedVector = other.pagedVector;
	}

	template<typename U>
	explicit FramePagedMemory(const FramePagedMemory<U>& other) {
		pagedVector = other.pagedVector;
	}
	...
	bool operator==(FramePagedMemory const&) { return true; }
	bool operator!=(FramePagedMemory const&) { return false; }
